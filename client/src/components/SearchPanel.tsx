        ...
        <Card className="w-full">
            ...
            <CardContent>
                <div className="flex gap-2 mb-4">
                    <Input
                        placeholder="Search for tutorials, articles, documentation..."
                        value={query}
                        ...
                        {webResults?.success && (
                            <div className="space-y-3">
                                <p className="text-sm text-muted-foreground">
                                    ...
                                    {webResults.searchInfo?.timeTaken && ` in ${webResults.searchInfo.timeTaken}`}
                                </p>
                            ...
                            <div className="space-y-6">
                                ...
                                {learningResults.resources.articles?.length > 0 && (
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {learningResults.resources.articles.map((article: any, idx: number) => (
                                                <Card key={idx} className="hover:bg-accent transition-colors">
                                ...
                                {learningResults.resources.documentation?.length > 0 && (
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {learningResults.resources.documentation.map((doc: any, idx: number) => (
                                                <Card key={idx} className="hover:bg-accent transition-colors">
                                                    <CardContent className="pt-3 pb-3">
                                                        <a
                                                            href={doc.url}
                                ...
                                {learningResults.resources.tutorials?.length > 0 && (
                                    <div>
                                        <h3 className="font-semibold mb-3">Interactive Tutorials</h3>
                                        <div className="space-y-2">
                                            {learningResults.resources.tutorials.map((tutorial: any, idx: number) => (
                                                <Card key={idx} className="hover:bg-accent transition-colors">
                                                    <CardContent className="pt-3 pb-3">
                                                        <a
                                                            href={tutorial.url}
