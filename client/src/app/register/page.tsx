  ...
  return (
    <main className="flex justify-center items-center min-h-screen bg-zinc-100 dark:bg-zinc-900 p-4 sm:p-5 transition-colors duration-300">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-20 w-48 h-48 sm:w-72 sm:h-72 bg-zinc-200 dark:bg-zinc-800 rounded-full blur-3xl opacity-40"></div>
        <div className="absolute bottom-20 right-20 w-64 h-64 sm:w-96 sm:h-96 bg-zinc-200 dark:bg-zinc-800 rounded-full blur-3xl opacity-40"></div>
      </div>
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          >
            <FaGraduationCap className="text-zinc-800 dark:text-zinc-100 text-6xl sm:text-7xl mx-auto mb-3 sm:mb-4" />
          </motion.div>
