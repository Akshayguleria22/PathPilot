  ...
  const loadHistory = async () => {
    ...
    if (existingLog) {
      ...
      setForm({
        ...
        entertainment: existingLog.entertainment || "",
        exercise: existingLog.exercise || "",
        foodQuality: existingLog.foodQuality || 3,
                ...
                >
                  <Card className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
                    <CardContent className="p-6">
                      <h3 className="text-lg font-bold text-blue-800 dark:text-blue-100 mb-2 flex items-center gap-2">
                        <FaCalendarAlt className="text-blue-600 dark:text-blue-400" />
                        You've already logged today!
                      </h3>
                      <p className="text-blue-700 dark:text-blue-200">
                        Your form is pre-filled with today's data. You can
                        update it if needed.
                      </p>
                    </CardContent>
                  </Card>
                ...
                {history.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-zinc-500">
                      Start logging your daily habits!
                    </p>
                  </motion.div>
                ) : (
                            ...
                            <div className="flex flex-wrap items-center justify-between mb-4">
                              ...
                              <div className="flex gap-2">
                                <Badge className="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-100 flex items-center gap-1">
                                  <FaBed className="text-xs" /> {h.sleep}h
                                </Badge>
                                <Badge className="bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-100 flex items-center gap-1">
                                  <FaBrain className="text-xs" /> {h.study}h
                                </Badge>
                                <Badge className="bg-pink-100 dark:bg-pink-900 text-pink-800 dark:text-pink-100 flex items-center gap-1">
                                  <FaSmile className="text-xs" /> {h.mood}/10
                                </Badge>
                              </div>
                            </div>
